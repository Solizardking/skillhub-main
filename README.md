...
|---|---|---|
| Skill sources | 240 canonical skills. Each slug is the directory path (relative to `skills/`) that owns a `SKILL.md`. | `skills/*/SKILL.md`, `skills/google/**/SKILL.md`, `skills/anthropic-skills/*/SKILL.md`, plus optional `references/`, `scripts/`, `assets/`, and `agents/` folders |
...
[`helius-skills/helius`](./skills/helius-skills/helius/SKILL.md) · [`helius-skills/helius-dflow`](./skills/helius-skills/helius-dflow/SKILL.md) · [`helius-skills/helius-jupiter`](./skills/helius-skills/helius-jupiter/SKILL.md) · [`helius-skills/helius-okx`](./skills/helius-skills/helius-okx/SKILL.md) · [`helius-skills/helius-phantom`](./skills/helius-skills/helius-phantom/SKILL.md) · [`helius-skills/svm`](./skills/helius-skills/svm/SKILL.md)
...
[`vulcan`](./skills/vulcan/SKILL.md) · [`vulcan-error-recovery`](./skills/vulcan-error-recovery/SKILL.md) · [`vulcan-execution-modes`](./skills/vulcan-execution-modes/SKILL.md) · [`vulcan-grid-trading`](./skills/vulcan-grid-trading/SKILL.md) · [`vulcan-lot-size-calculator`](./skills/vulcan-lot-size-calculator/SKILL.md) · [`vulcan-margin-operations`](./skills/vulcan-margin-operations/SKILL.md) · [`vulcan-market-intel`](./skills/vulcan-market-intel/SKILL.md) · [`vulcan-onboarding`](./skills/vulcan-onboarding/SKILL.md) · [`vulcan-portfolio-intel`](./skills/vulcan-portfolio-intel/SKILL.md) · [`vulcan-position-management`](./skills/vulcan-position-management/SKILL.md) · [`vulcan-quickstart`](./skills/vulcan-quickstart/SKILL.md) · [`vulcan-risk-management`](./skills/vulcan-risk-management/SKILL.md) · [`vulcan-skills-index`](./skills/vulcan-skills-index/SKILL.md) · [`vulcan-ta-strategy`](./skills/vulcan-ta-strategy/SKILL.md) · [`vulcan-technical-analysis`](./skills/vulcan-technical-analysis/SKILL.md) · [`vulcan-tpsl-management`](./skills/vulcan-tpsl-management/SKILL.md) · [`vulcan-trade-execution`](./skills/vulcan-trade-execution/SKILL.md) · [`vulcan-twap-execution`](./skills/vulcan-twap-execution/SKILL.md)
...
[`imperial`](./skills/imperial/SKILL.md) · [`imperial-execution-modes`](./skills/imperial-execution-modes/SKILL.md) · [`imperial-grid-trading`](./skills/imperial-grid-trading/SKILL.md) · [`imperial-margin-operations`](./skills/imperial-margin-operations/SKILL.md) · [`imperial-market-intel`](./skills/imperial-market-intel/SKILL.md) · [`imperial-portfolio-intel`](./skills/imperial-portfolio-intel/SKILL.md) · [`imperial-position-management`](./skills/imperial-position-management/SKILL.md) · [`imperial-risk-management`](./skills/imperial-risk-management/SKILL.md) · [`imperial-skills-index`](./skills/imperial-skills-index/SKILL.md) · [`imperial-tpsl-management`](./skills/imperial-tpsl-management/SKILL.md) · [`imperial-trade-execution`](./skills/imperial-trade-execution/SKILL.md) · [`imperial-twap-execution`](./skills/imperial-twap-execution/SKILL.md)
...
[`dflow-docs`](./skills/dflow-docs/SKILL.md) · [`dflow-kalshi-market-data`](./skills/dflow-kalshi-market-data/SKILL.md) · [`dflow-kalshi-market-scanner`](./skills/dflow-kalshi-market-scanner/SKILL.md) · [`dflow-kalshi-portfolio`](./skills/dflow-kalshi-portfolio/SKILL.md) · [`dflow-kalshi-trading`](./skills/dflow-kalshi-trading/SKILL.md) · [`dflow-phantom-connect`](./skills/dflow-phantom-connect/SKILL.md) · [`dflow-platform-fees`](./skills/dflow-platform-fees/SKILL.md) · [`dflow-proof-kyc`](./skills/dflow-proof-kyc/SKILL.md) · [`dflow-spot-trading`](./skills/dflow-spot-trading/SKILL.md)
...
[`ask-mcp`](./skills/ask-mcp/SKILL.md) · [`compressed-pda`](./skills/compressed-pda/SKILL.md) · [`compressed-token`](./skills/compressed-token/SKILL.md) · [`solana-redpill-verifier`](./skills/solana-redpill-verifier/SKILL.md) · [`solana-rent-free-dev`](./skills/solana-rent-free-dev/SKILL.md) · [`zk`](./skills/zk/SKILL.md) · [`zkrouter`](./skills/zkrouter/SKILL.md)
